...
//
//  Mat cv::imreadWithMetadata(String filename, vector_int& metadataTypes, vector_Mat& metadata, int flags)
//
/**
...
//
//  bool cv::imreadmulti(String filename, vector_Mat& mats, int flags = IMREAD_COLOR_BGR)
//
/**
...
//
//  size_t cv::imcount(String filename, int flags = IMREAD_COLOR_BGR)
//
/**
...
//
//  Mat cv::imdecodeWithMetadata(Mat buf, vector_int& metadataTypes, vector_Mat& metadata, int flags)
//
/**
