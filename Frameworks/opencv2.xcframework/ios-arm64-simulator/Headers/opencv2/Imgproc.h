...
typedef NS_ENUM(int, PutTextFlags) {
 ...
 * The Imgproc module
 *
 * Member classes: `GeneralizedHough`, `GeneralizedHoughBallard`, `GeneralizedHoughGuil`, `CLAHE`, `LineSegmentDetector`, `Filter2DParams`, `Moments`, `FontFace`
 *
 * Member enums: `SpecialFilter`, `MorphTypes`, `MorphShapes`, `InterpolationFlags`, `WarpPolarMode`, `InterpolationMasks`, `DistanceTransformMasks`, `ThresholdTypes`, `AdaptiveThresholdTypes`, `GrabCutClasses`, `GrabCutModes`, `DistanceTransformLabelTypes`, `FloodFillFlags`, `ConnectedComponentsTypes`, `ConnectedComponentsAlgorithmsTypes`, `RetrievalModes`, `ContourApproximationModes`, `ShapeMatchModes`, `HoughModes`, `HistCompMethods`, `LineSegmentDetectorModes`, `ColorConversionCodes`, `LineTypes`, `HersheyFonts`, `MarkerTypes`, `UndistortTypes`, `TemplateMatchModes`, `ColormapTypes`, `PutTextFlags`
 */
...
//
//  Ptr_LineSegmentDetector cv::createLineSegmentDetector(LineSegmentDetectorModes refine = LSD_REFINE_STD, double scale = 0.8, double sigma_scale = 0.6, double quant = 2.0, double ang_th = 22.5, double log_eps = 0, double density_th = 0.7, int n_bins = 1024)
//
/**
 ...
 * @param density_th Minimal density of aligned region points in the enclosing rectangle.
 */
+ (LineSegmentDetector*)createLineSegmentDetector:(LineSegmentDetectorModes)refine scale:(double)scale sigma_scale:(double)sigma_scale quant:(double)quant ang_th:(double)ang_th log_eps:(double)log_eps density_th:(double)density_th NS_SWIFT_NAME(createLineSegmentDetector(refine:scale:sigma_scale:quant:ang_th:log_eps:density_th:));
 ...
 * @param log_eps Detection threshold: -log10(NFA) \> log_eps. Used only when advance refinement is chosen.
 */
+ (LineSegmentDetector*)createLineSegmentDetector:(LineSegmentDetectorModes)refine scale:(double)scale sigma_scale:(double)sigma_scale quant:(double)quant ang_th:(double)ang_th log_eps:(double)log_eps NS_SWIFT_NAME(createLineSegmentDetector(refine:scale:sigma_scale:quant:ang_th:log_eps:));
 ...
 * @param ang_th Gradient angle tolerance in degrees.
 */
+ (LineSegmentDetector*)createLineSegmentDetector:(LineSegmentDetectorModes)refine scale:(double)scale sigma_scale:(double)sigma_scale quant:(double)quant ang_th:(double)ang_th NS_SWIFT_NAME(createLineSegmentDetector(refine:scale:sigma_scale:quant:ang_th:));
 ...
 * @param quant Bound to the quantization error on the gradient norm.
 */
+ (LineSegmentDetector*)createLineSegmentDetector:(LineSegmentDetectorModes)refine scale:(double)scale sigma_scale:(double)sigma_scale quant:(double)quant NS_SWIFT_NAME(createLineSegmentDetector(refine:scale:sigma_scale:quant:));
 ...
 * @param sigma_scale Sigma for Gaussian filter. It is computed as sigma = sigma_scale/scale.
 */
+ (LineSegmentDetector*)createLineSegmentDetector:(LineSegmentDetectorModes)refine scale:(double)scale sigma_scale:(double)sigma_scale NS_SWIFT_NAME(createLineSegmentDetector(refine:scale:sigma_scale:));
 ...
 * @param scale The scale of the image that will be used to find the lines. Range (0..1].
 */
+ (LineSegmentDetector*)createLineSegmentDetector:(LineSegmentDetectorModes)refine scale:(double)scale NS_SWIFT_NAME(createLineSegmentDetector(refine:scale:));
 ...
 * @param refine The way found lines will be refined, see ``LineSegmentDetectorModes``
 */
+ (LineSegmentDetector*)createLineSegmentDetector:(LineSegmentDetectorModes)refine NS_SWIFT_NAME(createLineSegmentDetector(refine:));
...
//
//  void cv::filter2D(Mat src, Mat& dst, Mat kernel, Filter2DParams params = Filter2DParams())
//
+ (void)filter2Dp:(Mat*)src dst:(Mat*)dst kernel:(Mat*)kernel params:(Filter2DParams*)params NS_SWIFT_NAME(filter2D(src:dst:kernel:params:));

+ (void)filter2Dp:(Mat*)src dst:(Mat*)dst kernel:(Mat*)kernel NS_SWIFT_NAME(filter2D(src:dst:kernel:));
 ...
 *
 * - SeeAlso fitEllipse, minEnclosingCircle
 */
 ...
 *
 * - SeeAlso ``warpAffine:dst:M:dsize:flags:borderMode:borderValue:hint:``, ``warpPerspective:dst:M:dsize:flags:borderMode:borderValue:hint:``, ``remap:dst:map1:map2:interpolation:borderMode:borderValue:hint:``
 */
...
//
//  void cv::warpAffine(Mat src, Mat& dst, Mat M, Size dsize, int flags = INTER_LINEAR, BorderTypes borderMode = BORDER_CONSTANT, Scalar borderValue = Scalar(), AlgorithmHint hint = cv::ALGO_HINT_DEFAULT)
//
/**
 ...
 * @param hint Implementation modification flags. Set ``AlgorithmHint/ALGO_HINT_APPROX`` to use FP16 precision (if available)
 * for linear calculation for faster speed. See ``AlgorithmHint``.
 *
 * - SeeAlso ``warpPerspective:dst:M:dsize:flags:borderMode:borderValue:hint:``, ``resize:dst:dsize:fx:fy:interpolation:``, ``remap:dst:map1:map2:interpolation:borderMode:borderValue:hint:``, ``getRectSubPix:patchSize:center:patch:patchType:``, transform
 */
+ (void)warpAffine:(Mat*)src dst:(Mat*)dst M:(Mat*)M dsize:(Size2i*)dsize flags:(int)flags borderMode:(BorderTypes)borderMode borderValue:(Scalar*)borderValue hint:(AlgorithmHint)hint NS_SWIFT_NAME(warpAffine(src:dst:M:dsize:flags:borderMode:borderValue:hint:));
...
//
//  void cv::warpPerspective(Mat src, Mat& dst, Mat M, Size dsize, int flags = INTER_LINEAR, BorderTypes borderMode = BORDER_CONSTANT, Scalar borderValue = Scalar(), AlgorithmHint hint = cv::ALGO_HINT_DEFAULT)
//
/**
 ...
 * for linear calculation for faster speed. See ``AlgorithmHint``.
 *
 * - SeeAlso ``warpAffine:dst:M:dsize:flags:borderMode:borderValue:hint:``, ``resize:dst:dsize:fx:fy:interpolation:``, ``remap:dst:map1:map2:interpolation:borderMode:borderValue:hint:``, ``getRectSubPix:patchSize:center:patch:patchType:``, perspectiveTransform
 */
+ (void)warpPerspective:(Mat*)src dst:(Mat*)dst M:(Mat*)M dsize:(Size2i*)dsize flags:(int)flags borderMode:(BorderTypes)borderMode borderValue:(Scalar*)borderValue hint:(AlgorithmHint)hint NS_SWIFT_NAME(warpPerspective(src:dst:M:dsize:flags:borderMode:borderValue:hint:));
...
//
//  void cv::remap(Mat src, Mat& dst, Mat map1, Mat map2, int interpolation, BorderTypes borderMode = BORDER_CONSTANT, Scalar borderValue = Scalar(), AlgorithmHint hint = cv::ALGO_HINT_DEFAULT)
//
/**
 ...
 * `$$map_1$$`, or fixed-point maps created by using ``Imgproc/convertMaps``. The reason you might want to
 ...
 */
+ (void)remap:(Mat*)src dst:(Mat*)dst map1:(Mat*)map1 map2:(Mat*)map2 interpolation:(int)interpolation borderMode:(BorderTypes)borderMode borderValue:(Scalar*)borderValue hint:(AlgorithmHint)hint NS_SWIFT_NAME(remap(src:dst:map1:map2:interpolation:borderMode:borderValue:hint:));
 ...
 *
 * - SeeAlso ``remap:dst:map1:map2:interpolation:borderMode:borderValue:hint:``, ``undistort:dst:cameraMatrix:distCoeffs:newCameraMatrix:``, ``initUndistortRectifyMap:distCoeffs:R:newCameraMatrix:size:m1type:map1:map2:``
 */
 ...
 *
 * The function is simply a combination of ``Imgproc/initUndistortRectifyMap`` (with unity R ) and ``Imgproc/remap``
 ...
 * result in the form of maps for ``Imgproc/remap``. The undistorted image looks like original, as if it is
 ...
 *
 * The function actually builds the maps for the inverse mapping algorithm that is used by ``Imgproc/remap``. That
 ...
 * @param m1type Type of the first output map that can be CV_32FC1, CV_32FC2 or CV_16SC2, see ``Imgproc/convertMaps``
 ...
 * ``Imgproc/initUndistortRectifyMap`` to accomodate stereo-rectification of projectors ('inverse-cameras') in projector-camera pairs.
 *
 * The function computes the joint projection and inverse rectification transformation and represents the
 * result in the form of maps for ``Imgproc/remap``. The projected image looks like a distorted version of the original which,
 ...
 * this helps align the projector (in the same manner as ``Imgproc/initUndistortRectifyMap`` for the camera) to create a stereo-rectified pair. This
 * allows epipolar lines on both images to become horizontal and have the same y-coordinate (in case of a horizontally aligned projector-camera pair).
 *
 * The function builds the maps for the inverse mapping algorithm that is used by ``Imgproc/remap``. That
 ...
 *
 * In case of a stereo-rectified projector-camera pair, this function is called for the projector while ``Imgproc/initUndistortRectifyMap`` is called for the camera head.
 ...
 * @param m1type Type of the first output map. Can be CV_32FC1, CV_32FC2 or CV_16SC2, see ``Imgproc/convertMaps``
 * @param map1 The first output map for ``Imgproc/remap``.
 * @param map2 The second output map for ``Imgproc/remap``.
 */
 ...
 *
 * - SeeAlso ``warpAffine:dst:M:dsize:flags:borderMode:borderValue:hint:``, ``warpPerspective:dst:M:dsize:flags:borderMode:borderValue:hint:``
 */
...
//
/**
 * Draw axes of the world/object coordinate system from pose estimation. - SeeAlso solvePnP
 *
...
//
//  Point cv::putText(Mat& img, String text, Point org, Scalar color, FontFace fface, int size, int weight = 0, PutTextFlags flags = PUT_TEXT_ALIGN_LEFT, Range wrap = Range())
//
/**
 ...
 */
+ (Point2i*)putText:(Mat*)img text:(NSString*)text org:(Point2i*)org color:(Scalar*)color fface:(FontFace*)fface size:(int)size weight:(int)weight flags:(PutTextFlags)flags wrap:(Range*)wrap NS_SWIFT_NAME(putText(img:text:org:color:fface:size:weight:flags:wrap:));
 ...
 *        [0, org.x] is for RTL one.
 */
+ (Point2i*)putText:(Mat*)img text:(NSString*)text org:(Point2i*)org color:(Scalar*)color fface:(FontFace*)fface size:(int)size weight:(int)weight flags:(PutTextFlags)flags NS_SWIFT_NAME(putText(img:text:org:color:fface:size:weight:flags:));
 ...
 *        [0, org.x] is for RTL one.
 */
+ (Point2i*)putText:(Mat*)img text:(NSString*)text org:(Point2i*)org color:(Scalar*)color fface:(FontFace*)fface size:(int)size weight:(int)weight NS_SWIFT_NAME(putText(img:text:org:color:fface:size:weight:));
 ...
 *        [0, org.x] is for RTL one.
 */
+ (Point2i*)putText:(Mat*)img text:(NSString*)text org:(Point2i*)org color:(Scalar*)color fface:(FontFace*)fface size:(int)size NS_SWIFT_NAME(putText(img:text:org:color:fface:size:));


//
//  Rect cv::getTextSize(Size imgsize, String text, Point org, FontFace fface, int size, int weight = 0, PutTextFlags flags = PUT_TEXT_ALIGN_LEFT, Range wrap = Range())
//
/**
 ...
 * @param flags Various flags, see PUT_TEXT_...
 * @param wrap The optional text wrapping range; see ``Imgproc/putText``.
 */
+ (Rect2i*)getTextSize:(Size2i*)imgsize text:(NSString*)text org:(Point2i*)org fface:(FontFace*)fface size:(int)size weight:(int)weight flags:(PutTextFlags)flags wrap:(Range*)wrap NS_SWIFT_NAME(getTextSize(imgsize:text:org:fface:size:weight:flags:wrap:));
 ...
 * @param flags Various flags, see PUT_TEXT_...
 */
+ (Rect2i*)getTextSize:(Size2i*)imgsize text:(NSString*)text org:(Point2i*)org fface:(FontFace*)fface size:(int)size weight:(int)weight flags:(PutTextFlags)flags NS_SWIFT_NAME(getTextSize(imgsize:text:org:fface:size:weight:flags:));
 ...
 *         whatever "default" weight the used font provides.
 */
+ (Rect2i*)getTextSize:(Size2i*)imgsize text:(NSString*)text org:(Point2i*)org fface:(FontFace*)fface size:(int)size weight:(int)weight NS_SWIFT_NAME(getTextSize(imgsize:text:org:fface:size:weight:));
 ...
 *         whatever "default" weight the used font provides.
 */
+ (Rect2i*)getTextSize:(Size2i*)imgsize text:(NSString*)text org:(Point2i*)org fface:(FontFace*)fface size:(int)size NS_SWIFT_NAME(getTextSize(imgsize:text:org:fface:size:));
